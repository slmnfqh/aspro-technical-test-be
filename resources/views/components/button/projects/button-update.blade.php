...
<div
    ...
    <button id="defaultModalButtonEdit{{ $project->id }}" data-modal-target="defaultModalEdit{{ $project->id }}"
        data-modal-toggle="defaultModalEdit{{ $project->id }}"
...
<!-- Main modal -->
<div id="defaultModalEdit{{ $project->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="overflow-y-auto max-h-96 grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Project
                            Description</label>
                        <input id="description{{ $project->id }}" type="hidden" name="description"
                            value="{{ old('description', $project->description) }}">
                        <trix-editor input="description{{ $project->id }}"
