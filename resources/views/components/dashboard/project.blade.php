            ...
            <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
                ...
                <article
                    ...
                    <header class="mb-4 lg:mb-6 not-format">
                        <a href="/dashboard/projects" class="font-medium text-sm text-blue-500 hover:underline">&laquo;
                            Back
                            to all projects
                        </a>
                        ...
                        <div class=" py-3 flex gap-2 items-center">
                            ...
                            <form action="/dashboard/projects/{{ $project->slug }}" method="post" class="inline m-0">
                                @method('delete')
                                @csrf
                                <button
                                ...
                                <div>
                                    ...
                                    <p class="text-base text-gray-500 dark:text-gray-400 mt-1">
                                        <a href="/projects?category={{ $project->category->slug }}">
                                            <span
                                                class="bg-{{ $project->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-1.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800 hover:bg-primary-100">
