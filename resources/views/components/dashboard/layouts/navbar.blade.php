<nav
    class="bg-[#161d1f] border-b border-gray-200 lg:px-10 px-4 py-3.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50 ">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-gray-300 italic">My
                    Dashboard</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="{{ asset('assets/images/pqh-universe.png') }}"
                    alt="user photo" />
            </button>
            <!-- Dropdown menu -->
