<nav class="bg-gray-800" x-data="{ isOpen: false }">
    {{-- /*krn agar bisa akses oleh element turunannya */ --}}
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        {{-- is() = Mengecek apakah URL saat ini --}}
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Sulaiman Faqih</div>
                    <div class="text-sm font-medium text-gray-400">slmnfqh@example.com</div>
                </div>
            </div>
