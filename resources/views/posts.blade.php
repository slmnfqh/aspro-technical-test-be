    ...
    <x-slot:main>
        <div class="flex items-center justify-between ">
            <div class="lg:flex hidden flex-row items-center gap-2">
                ...
                <p class="font-bold text-[1.5rem] italic">Posts</p>
            </div>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 ">
                ...
                @forelse ($posts as $post)
                    <article
                        ...
                        <img src="{{ $post->image_url }}" alt="gambar" width="400" height="300"
                            class="rounded-md mb-2">
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a
                                href="/post/{{ $post->slug }}" class="hover:underline">{{ $post->title }} </a></h2>
                ...
                @empty
                    <div class="h-screen inline md:grid-cols-2 lg:w-[75rem] lg:pt-6rem">
